...
public class RangeExpressionTest {
  ...
  FilterUnsupportedException {
    RowImpl rowImpl = new RowImpl();
    rowImpl.setValues(new Boolean[] { false });
    final ExpressionResult expressionResult = new ExpressionResult(DataType.BOOLEAN, "true");
    new MockUp<ColumnExpression>() {
      @Mock public ExpressionResult evaluate(RowIntf value) {
        return expressionResult;
      }
  ...
  @Test public void testEvaluate2() throws FilterIllegalMemberException,
    ...
    RowImpl rowImpl = new RowImpl();
    rowImpl.setValues(new Boolean[] { false });
    final ExpressionResult expressionResultRight = new ExpressionResult(DataType.BOOLEAN, "false");
    final ExpressionResult expressionResultLeft = new ExpressionResult(DataType.BOOLEAN, "true");
    new MockUp<ColumnExpression>() {
      boolean isLeft = true;
      @Mock public ExpressionResult evaluate(RowIntf value) {
        if (isLeft) {
  ...
  @Test public void testEvaluate3() throws FilterIllegalMemberException,
    ...
    rowImpl.setValues(new Boolean[] { false });
    final ExpressionResult expressionResultRight = new ExpressionResult(DataType.BOOLEAN, "false");
    final ExpressionResult expressionResultLeft = new ExpressionResult(DataType.BOOLEAN, "false");
    new MockUp<ColumnExpression>() {
      boolean isLeft = true;
      @Mock public ExpressionResult evaluate(RowIntf value) {
        if (isLeft) {
  ...
  @Test public void testEvaluate4()
    ...
    RowImpl rowImpl = new RowImpl();
    rowImpl.setValues(new Boolean[] { false });
    final ExpressionResult expressionResult = new ExpressionResult(DataType.BOOLEAN, "false");
    new MockUp<ColumnExpression>() {
      @Mock public ExpressionResult evaluate(RowIntf value) {
        return expressionResult;
      }
